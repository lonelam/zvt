...
from zvt.domain import Index, Index1dKdata, IndexStock, Index1mKdata
...
def record_index(sleeping_time=10):
    run_data_recorder(domain=Index, data_provider="exchange", sleeping_time=sleeping_time)
...
def record_qmt_index():
    Index1mKdata.record_data(provider="qmt", entity_ids=["index_sh_000001"])


if __name__ == "__main__":
    init_log("index_runner.log")
    record_qmt_index()
    record_index(sleeping_time=0)
    record_index_kdata()
